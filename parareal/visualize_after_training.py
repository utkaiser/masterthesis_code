...
from parareal.utils_visualization import plot_wavefield_results, get_ticks_fine
...
from generate_data.wave_util import crop_center, WaveSol_from_EnergyComponent_tensor, WaveEnergyComponentField_tensor
import torch
