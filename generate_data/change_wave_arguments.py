...
def WaveEnergyComponentField_end_to_end(
        u,
        ut,
        c,
        dx
...
def WaveEnergyComponentField_tensor(
        u,
        ut,
        c,
        dx
...
def WaveSol_from_EnergyComponent(
        wx,
        wy,
        wtc,
        c,
...
def WaveSol_from_EnergyComponent_tensor(
        wx,
        wy,
        wtc,
        c,
